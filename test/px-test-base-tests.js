...
function runBaseTests() {
  px_test_1 = document.getElementById('px_test_1');

  suite('Base Automation Tests for px-test', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-test fixture is created', function() {
      assert.isTrue(document.getElementById('px_test_1') !== null);
    });
